        ...
        for dir_label, cond, target, t0, t1, t2 in directions:
            ...
            for i in range(n):
                ...
                axes[i, 0].set_ylabel(f"id={galaxy_ids[i]}", fontsize=7, rotation=0,
                                      labelpad=30, va="left", color="magenta")
...
# ---------------------------------------------------------------------------
H5_PATH     = "/n03data/fontirro/data_files/euclid_cosmos_pairs_v4.h5"
CKPT_DIR    = "/n03data/fontirro/checkpoints/euclid-cosmos-vis-f150w/test-3-phase1"  # where to save checkpoints and logs
